...
public class GameScreenGUI implements Runnable {
    ...
    private void createComponents(Container container) {
        ...
        DiceOneListener listener1 = new DiceOneListener(dice, game, die1, doneRolling);
        DiceTwoListener listener2 = new DiceTwoListener(dice, game, die2, doneRolling);
        DiceThreeListener listener3 = new DiceThreeListener(dice, game, die3, doneRolling);
        DiceFourListener listener4 = new DiceFourListener(dice, game, die4, doneRolling);
        DiceFiveListener listener5 = new DiceFiveListener(dice, game, die5, doneRolling);
